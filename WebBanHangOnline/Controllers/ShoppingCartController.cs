    ...
    public class ShoppingCartController : Controller
    {
        ...
        public ActionResult CheckOut(OrderViewModel req)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (cart != null)
                {
                    ...
                    WebBanHangOnline.Common.Common.SendMail("ShopOnline", "Đơn dịch vụ #" + order.Code, contentCustomer.ToString(), req.Email);
                    ...
                    WebBanHangOnline.Common.Common.SendMail("ShopOnline", "Đơn dịch vụ mới #" + order.Code, contentAdmin.ToString(), ConfigurationManager.AppSettings["EmailAdmin"]);
                    cart.ClearCart();
        ...
        public ActionResult AddToCart(int id, int quantity)
        {
            ...
            if (checkProduct != null)
            {
                ...
                Session["Cart"] = cart;
                code = new { Success = true, msg = "Thêm dịch vụ vào giỏ thành công!", code = 1, Count = cart.Items.Count };
            }
            return Json(code);
        }
        ...
        public string UrlPayment(int TypePaymentVN, string orderCode)
        {
            ...
            vnpay.AddRequestData("vnp_OrderInfo", "Thanh toán Đơn dịch vụ :" + order.Code);
            vnpay.AddRequestData("vnp_OrderType", "other"); //default value: other

            vnpay.AddRequestData("vnp_ReturnUrl", vnp_Returnurl);
            vnpay.AddRequestData("vnp_TxnRef", order.Code); // Mã tham chiếu của giao dịch tại hệ thống của merchant. Mã này là duy nhất dùng để phân biệt các Đơn dịch vụ gửi sang VNPAY. Không được trùng lặp trong ngày
